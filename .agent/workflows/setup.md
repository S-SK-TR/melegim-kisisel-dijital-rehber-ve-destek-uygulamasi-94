...
- `CLAUDE.md` dosyasındaki `Meleğim - Kişisel Dijital Rehber ve Destek Uygulaması`, `Meleğim - Kişisel Dijital Rehber ve Destek Uygulaması — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
